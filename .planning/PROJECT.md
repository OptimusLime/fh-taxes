...
**Subject municipality:** Fair Haven Borough, Monmouth County, NJ. ~6,100 residents. **Real measured (verified 2026-04-29 against live NJGIN + DLGS data):** 2,305 parcels total in NJGIN; 2,064 class-2 residential per MOD-IV with $2,740,871,000 aggregate NET_VALUE; 2,061 of those have geometry (used for analysis). DLGS-published Net Valuation Taxable across all property classes = $2,827,194,216. 2025 Director's Ratio 101.96% (per published equalization tables). NJGIN MUN code = "1314"; DLGS MuniCode = "1313" (different schemes for the same town). SR1A district = "14" (county "13" + district "14"). **General tax rate (2025, computed from DLGS) = $1.427/$100** — PROJECT.md originally cited $1.574 from a pre-research narrative; the live DLGS Municipal Tax Summary yields $1.427 (Total Levy $40,339,309.77 ÷ Net Valuation Taxable × 100). Levy split (real 2025 dollars): county $6.14M, local school $18.04M, regional school (RFH) $7.37M, municipal $8.79M = $40.34M total. Schools share ≈ 63% (consistent with original framing). Annual reassessment under Monmouth ADP (P.L. 2013, c. 15; N.J.S.A. 54:1-101 et seq.) — 5-year rolling inspection cycle, January 15 appeal deadline, valuation date Oct 1 of pretax year. Assessor: Greg Hutchinson (RDS contractor for inspections).
