...
- [x] 01.5-03-PLAN.md — OPRS HTML parsers: parse_m4.py + parse_sr.py with unit tests [DATA-05, DATA-06]
- [x] 01.5-04-PLAN.md — OPRS PDF parsers: parse_prc_pdf + parse_ch75_pdf + parse_taxlist_pdf via pdfplumber [DATA-07, DATA-08]
- [x] 01.5-05-PLAN.md — scripts/build_prc_parquet.py aggregator → data/processed/prc.parquet + sales enrichment [DATA-05..08]
